...
var autoScenarioConfigForEmber = require('./auto-scenario-config-for-ember');
...
function config(options) {
  ...
  if (configData && configData.scenarios && !configData.useVersionCompatibility) {
    return configData;
  }

  var versionCompatibility = versionCompatibilityFromPackageJSON(options.project.root);

  if (versionCompatibility) {
    var autoConfig = autoScenarioConfigForEmber(versionCompatibility);
